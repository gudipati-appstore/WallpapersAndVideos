...
public class VideoOptionsAdapter extends RecyclerView.Adapter<VideoOptionsAdapter.MyViewHolder> {

    private List<String> optionsList;
    private Context mContext;
    private ButtonClick buttonClick;

    public VideoOptionsAdapter(Context mContext, List<String> optionsList, ButtonClick buttonClick) {
    ...
    @Override
    public VideoOptionsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View imageView = inflater.inflate(R.layout.video_option_row, parent, false);

        return new MyViewHolder(imageView);
    }

    @Override
    public void onBindViewHolder(final VideoOptionsAdapter.MyViewHolder holder, int position) {
